...
gv.SAMPLES_INBOX = "/samples/"  # Builtin directory containing the sample-sets.
gv.SAMPLES_ONUSB = "/samples/"    # USB-Mount directory containing the sample-sets.
CONFIG_LOC = gv.rootprefix+"/configuration/"
